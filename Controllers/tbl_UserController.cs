...
namespace concurrentprj.Controllers
{
    public class tbl_UserController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserID,UserName,Password,AdminCode")] tbl_User tbl_User)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserID,UserName,Password,AdminCode")] tbl_User tbl_User)
        {
            if (ModelState.IsValid)
            {
